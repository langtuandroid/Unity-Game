...
namespace LobsterFramework.AbilitySystem
{
    ...
    public class AbilityData : ScriptableObject
    {
        ...
        public void Initialize(AbilityRunner actionable)
        {
        ...
        public bool AbilityStatsCheck<T>() where T : Ability
        {
            Type type = typeof(T);
            bool f1 = true;
        ...
        public bool AddAbilityStat<T>() where T : AbilityStat
        {
        ...
        public bool AddAbility<T>() where T : Ability
        {
        ...
        public bool RemoveAbility<T>() where T : Ability
        {
        ...
        public bool RemoveAbilityStat<T>() where T : AbilityStat
        {
            string str = typeof(T).ToString();
            if (stats.ContainsKey(str))
            {
